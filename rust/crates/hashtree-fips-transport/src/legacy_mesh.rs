//! Legacy mesh request, application-message, and pubsub transport.

use async_trait::async_trait;
#[cfg(test)]
use fips_core::config::RoutingMode;
...
#[cfg(test)]
use crate::bind_fips_endpoint;
use crate::endpoint::set_fips_peer_configs;
#[cfg(test)]
use crate::endpoint::{fips_endpoint_config, peer_address_from_configured_addr};
#[cfg(test)]
use crate::{FipsEndpointOptions, DEFAULT_FIPS_DISCOVERY_SCOPE};
use crate::{FipsPeerConfig, FipsTransportError};
...
impl FipsEndpointIo for fips_core::FipsEndpoint {
    ...
    async fn set_peer_configs(
        ...
        set_fips_peer_configs(self, peer_configs).await
    }
