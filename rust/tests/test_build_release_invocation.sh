...
grep -Fx "args:build --release --target aarch64-apple-darwin -p git-remote-htree -p hashtree-cashu-cli -p hashtree-cli --features hashtree-cli/fips-webrtc --locked" "${LOG_DIR}/cargo.log" >/dev/null
grep -Fx "args:build --release --target x86_64-apple-darwin -p git-remote-htree -p hashtree-cashu-cli -p hashtree-cli --features hashtree-cli/fips-webrtc --locked" "${LOG_DIR}/cargo.log" >/dev/null
...
grep -Fx "args:build --release --target x86_64-unknown-linux-musl -p git-remote-htree -p hashtree-cashu-cli -p hashtree-cli --features hashtree-cli/fips-webrtc --locked" "${LOG_DIR}/cross.log" >/dev/null
