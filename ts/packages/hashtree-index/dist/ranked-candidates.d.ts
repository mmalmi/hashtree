...
export declare function loadTermFrequencies(btree: BTree, termsRoot: CID, terms: readonly string[], selectedFields: ReadonlySet<string>, configuredFields: ReadonlyMap<string, unknown>, documentCount: number): Promise<{
...
export declare function postingMatchesFields(posting: RankedPosting, fields: ReadonlySet<string>): boolean;
